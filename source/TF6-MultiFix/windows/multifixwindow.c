...
{
    {NULL, NULL, 0, 1, 0.0f, 0.0f, MENUWINDOW_ITEM_TYPE_BOOL, 0, 0, 0, 1, MFWINDOW_ITEM_SWAPBUTTON, MFWINDOW_ITEM_NAME_SWAPBUTTON, MFWINDOW_ITEM_DESC_SWAPBUTTON, NULL},
    {NULL, NULL, 0, 1, 0.0f, 0.0f, MENUWINDOW_ITEM_TYPE_BOOL, 0, 0, 0, 1, MFWINDOW_ITEM_MATRIXFONT, MFWINDOW_ITEM_NAME_MATRIXFONT, MFWINDOW_ITEM_DESC_MATRIXFONT, NULL},
    {NULL, NULL, 0, 1, 0.0f, 0.0f, MENUWINDOW_ITEM_TYPE_BOOL, 0, 0, 0, 1, MFWINDOW_ITEM_PARTNERCARD, MFWINDOW_ITEM_NAME_PARTNERCARD, MFWINDOW_ITEM_DESC_PARTNERCARD, NULL},
    {NULL, NULL, 0, 1, 0.0f, 0.0f, MENUWINDOW_ITEM_TYPE_BOOL, 0, 0, 0, 1, MFWINDOW_ITEM_DUELHELP, MFWINDOW_ITEM_NAME_DUELHELP, MFWINDOW_ITEM_DESC_DUELHELP, NULL},
    {NULL, NULL, 0, 1, 0.0f, 0.0f, MENUWINDOW_ITEM_TYPE_BOOL, 0, 0, 0, 1, MFWINDOW_ITEM_INSTALLDISABLE, MFWINDOW_ITEM_NAME_INSTALLDISABLE, MFWINDOW_ITEM_DESC_INSTALLDISABLE, NULL},
    {NULL, NULL, 0, 0, 0.0f, 0.0f, MENUWINDOW_ITEM_TYPE_NONE, 0, 1, 0, 0, MFWINDOW_ITEM_SOUNDTEST, MFWINDOW_ITEM_NAME_SOUNDTEST, MFWINDOW_ITEM_DESC_SOUNDTEST, NULL},
    // cheats are always here
    {NULL, NULL, 0, 0, 0.0f, 0.0f, MENUWINDOW_ITEM_TYPE_NONE, 1, 1, 0, 0, MFWINDOW_ITEM_CHEATSGLOBAL, MFWINDOW_ITEM_NAME_CHEATSGLOBAL, MFWINDOW_ITEM_DESC_CHEATSGLOBAL, NULL},
    {NULL, NULL, 0, 0, 0.0f, 0.0f, MENUWINDOW_ITEM_TYPE_NONE, 1, 1, 0, 0, MFWINDOW_ITEM_CHEATSLOCAL, MFWINDOW_ITEM_NAME_CHEATSLOCAL, MFWINDOW_ITEM_DESC_CHEATSLOCAL, NULL},
