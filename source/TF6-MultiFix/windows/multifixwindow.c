...
MenuWindowItem mfWindowSettings[MFWINDOW_ITEM_COUNT] =
{
    ...
    {NULL, 0, 1, MENUWINDOW_ITEM_TYPE_BOOL, 0, 0, 0, 1, 0, 0, MFWINDOW_ITEM_UTF8STORY, MFWINDOW_ITEM_NAME_UTF8STORY, MFWINDOW_ITEM_DESC_UTF8STORY, NULL, 0, 0, 0},
    {NULL, 0, 1, MENUWINDOW_ITEM_TYPE_BOOL, 0, 0, 0, 1, 0, 0, MFWINDOW_ITEM_SENSIBLEXPDISPLAY, MFWINDOW_ITEM_NAME_SENSIBLEXPDISPLAY, MFWINDOW_ITEM_DESC_SENSIBLEXPDISPLAY, NULL, 0, 0, 0},
...
void mfwindow_Create()
{
    ...
    mfWindowSettings[MFWINDOW_ITEM_SENSIBLEXPDISPLAY].val = &config->basic.bSensibleExpDisplay;
