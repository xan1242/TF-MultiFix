...
int cheatmenu_global_cbReadLevel(uintptr_t)
{
    return YgSys_uGetLevel();
}

int cheatmenu_global_cbWriteLevel(int value, uintptr_t)
{
    YgSys_uSetLevel(value - 1);
    return 0;
}

int cheatmenu_global_cbReadXp(uintptr_t)
{
    return YgSys_uGetExp(GETEXP_MODE_CURRENT);
}

int cheatmenu_global_cbWriteXp(int value, uintptr_t)
{
    YgSys_uSetExp(value);
    return 0;
}
...
MenuWindowItem cheatmenu_global_Items[CHEATMENU_GLOBAL_ITEM_COUNT] =
{
    ...
    {NULL, -1, 5, MENUWINDOW_ITEM_TYPE_INT, 0, 0, 0, 0, 0, 0, CHEATMENU_GLOBAL_ITEM_CUSTOMRENTLIMIT, CHEATMENU_GLOBAL_ITEM_NAME_CUSTOMRENTLIMIT, CHEATMENU_GLOBAL_DESC_NAME_CUSTOMRENTLIMIT, NULL, 0, 0, 0},
    ...
    {NULL, 1, INT32_MAX, MENUWINDOW_ITEM_TYPE_INT, 0, 0, 0, 0, 0, 0, CHEATMENU_GLOBAL_ITEM_SETLEVEL, CHEATMENU_GLOBAL_ITEM_NAME_SETLEVEL, CHEATMENU_GLOBAL_DESC_NAME_SETLEVEL, NULL, (uintptr_t)&cheatmenu_global_cbReadLevel, (uintptr_t)&cheatmenu_global_cbWriteLevel, 0},
    {NULL, 0, INT32_MAX, MENUWINDOW_ITEM_TYPE_INT, 0, 0, 0, 0, 0, 0, CHEATMENU_GLOBAL_ITEM_SETXP, CHEATMENU_GLOBAL_ITEM_NAME_SETXP, CHEATMENU_GLOBAL_DESC_NAME_SETXP, NULL, (uintptr_t)&cheatmenu_global_cbReadXp, (uintptr_t)&cheatmenu_global_cbWriteXp, 0},
...
void cheatmenu_global_Create()
{
    ...
    cheatmenu_global_Items[CHEATMENU_GLOBAL_ITEM_CUSTOMRENTLIMIT].val = &config->extra.CheatMaxRents;
