...
{
    {NULL, NULL, 0, UINT16_MAX, 0.0f, 0.0f, MENUWINDOW_ITEM_TYPE_INT, 0, 1, 0, 0, CHEATMENU_DUEL_ITEM_SETOPPONENTLP, NULL, NULL},
    {NULL, NULL, 0, UINT16_MAX, 0.0f, 0.0f, MENUWINDOW_ITEM_TYPE_INT, 0, 1, 0, 0, CHEATMENU_DUEL_ITEM_SETPLAYERLP, NULL, NULL},
    {NULL, NULL, 0, 0, 0.0f, 0.0f,          MENUWINDOW_ITEM_TYPE_NONE, 0, 1, 0, 0, CHEATMENU_DUEL_ITEM_DRAWCARD, NULL, NULL},
    {NULL, NULL, 0, 0, 0.0f, 0.0f,          MENUWINDOW_ITEM_TYPE_NONE, 0, 1, 0, 0, CHEATMENU_DUEL_ITEM_TAKEAICONTROL, NULL, NULL},
    {NULL, NULL, 0, 0, 0.0f, 0.0f,          MENUWINDOW_ITEM_TYPE_NONE, 0, 1, 0, 0, CHEATMENU_DUEL_ITEM_GIVEAICONTROL, NULL, NULL},
};
